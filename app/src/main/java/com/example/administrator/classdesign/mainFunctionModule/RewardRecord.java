 ...
 */
public class RewardRecord extends Activity {
    ...
    protected  void onCreate(Bundle savedinstanceState){
        ...
        setContentView(R.layout.reward_record_layout);
        lv=(ListView)findViewById(R.id.reward_content_id);
        ...
        return_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(RewardRecord.this,MainActivity.class);
                startActivity(in);
            }
        });
        new Thread() {
            ...
            public void run() {
                super.run();
                try {
                    l = LoginTool.get_penalties();
                    simpleAdapter = new SimpleAdapter(RewardRecord.this, l, R.layout.reward_record_content, new String[]{"0","1","2","3","4","5"}, new int[]{R.id.r1, R.id.r2,
                            R.id.r3,R.id.r4,R.id.r5,R.id.r6});
