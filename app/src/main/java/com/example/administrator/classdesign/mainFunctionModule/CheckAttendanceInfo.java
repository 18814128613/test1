 ...
 */
public class CheckAttendanceInfo extends Activity {
    ...
    protected  void onCreate(Bundle savedinstanceState){
        ...
        setContentView(R.layout.check_attendance_info_layout);
        lv=(ListView)findViewById(R.id.CA_info_id);
        ...
        return_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(CheckAttendanceInfo.this,MainActivity.class);
                startActivity(in);
            }
        });
        new Thread() {
            ...
            public void run() {
                super.run();
                try {
                    l = LoginTool.get_attendance();

                    simpleAdapter = new SimpleAdapter(CheckAttendanceInfo.this, l, R.layout.check_attendance_info_content, new String[]{"0","1","2"}, new int[]{R.id.s1, R.id.s2,
                            R.id.s3});
